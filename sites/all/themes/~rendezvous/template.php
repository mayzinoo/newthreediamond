...
$parent_root = base_path() . drupal_get_path('theme', 'rendezvous');

/**
 * Assign theme hook suggestions for custom templates.
 */  
function rendezvous_preprocess_page(&$vars, $hook) {
  if (isset($vars['node'])) {
...
function rendezvous_preprocess_node(&$vars) {
 ...
 */
function rendezvous_process_page(&$variables) {	
...
function rendezvous_menu_link(array $variables) {
...
function rendezvous_links($variables) {
...
function rendezvous_pagination($node, $mode = 'n') {
 ...
 */
function rendezvous_preprocess_username(&$vars) {
  global $theme_key;
 ...
 */
function rendezvous_field($variables) {
...
/**
 * User CSS function. Separate from rendezvous_preprocess_html so function can be called directly before </head> tag.
 */
function rendezvous_user_css() {
 ...
 */
function rendezvous_preprocess_html(&$vars){
  global $parent_root;
