 ...
 */  
function stargrace_preprocess_page(&$vars, $hook) {
  if (isset($vars['node'])) {
...
function stargrace_preprocess_node(&$vars) {
 ...
 */
function stargrace_process_page(&$variables) {	
...
function stargrace_menu_link(array $variables) {
...
function stargrace_links($variables) {
...
function stargrace_pagination($node, $mode = 'n') {
 ...
 */
function stargrace_preprocess_username(&$vars) {
  global $theme_key;
 ...
 */
function stargrace_field($variables) {
 ...
 */
function stargrace_preprocess_html(&$vars){
  global $parent_root;
